  ...
  return {
    threads: [
      ...
      },
      {
        ...
        contextId: 'demo-support-request',
        contextType: 'SUPPORT',
        createdAt: now,
        hasEvidencePhoto: true,
        id: 'support:demo-support-thread',
        issueTypeLabel: 'TASK_HELP',
        lastMessageAt: now,
        lastMessagePreview: 'Taskly Support replied with the next step for your task.',
        linkedContext: {
          id: 'demo-task',
          label: 'Demo Taskly task',
          type: 'task',
        },
        messageCount: 3,
        nextRecommendedAction: 'Open conversation',
        otherParticipantName: 'Taskly',
        roleLabel: 'Support',
        statusLabel: 'Open',
        subtitle: 'Taskly',
        supportStatus: 'OPEN',
        title: 'Need help with my demo task',
        unreadCount: 0,
      },
    ],
  };
